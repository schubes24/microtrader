...
#AWS ECR settings
DOCKER_REGISTRY ?= 776481483165.dkr.ecr.us-east-1.amazonaws.com
AWS_ACCOUNT_ID ?= 776481483165
DOCKER_LOGIN_EXPRESSION := eval $$(aws ecr get-login --registry-id $(AWS_ACCOUNT_ID))
